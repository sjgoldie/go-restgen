module example/scoped

go 1.26.6

require (
	github.com/go-chi/chi/v5 v5.3.1
	github.com/sjgoldie/go-restgen v0.0.0
...
// For local development - remove when using released version
replace github.com/sjgoldie/go-restgen => ../..
