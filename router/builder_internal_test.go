...
func TestMaxUploadSizeDefault(t *testing.T) {
	...
	t.Run("file resource gets DefaultMaxUploadSize when not specified", func(t *testing.T) {
		...
		_, setup := prepareMetadata[fileModel](b, "/files", nil, nil, nil, nil, nil, 0, "", true, "", nil, "", false, false, nil, 0, 0)
	...
	t.Run("custom MaxUploadSize is set on metadata", func(t *testing.T) {
		...
		_, setup := prepareMetadata[fileModel](b, "/files", nil, nil, nil, nil, nil, 0, "", true, "", nil, "", false, false, nil, 0, customSize)
	...
	t.Run("non-file resource gets DefaultMaxUploadSize", func(t *testing.T) {
		...
		_, setup := prepareMetadata[testModel](b, "/items", nil, nil, nil, nil, nil, 0, "", false, "", nil, "", false, false, nil, 0, 0)
